\documentclass{bernhard_cv}

\setname{Bernhard}{Rippich}
\setaddress{Regensburg/Germany}
\setmobile{+49 151 65169008}
\setmail{bernhard.rippich@st.oth-regensburg.de}
\setposition{Work Student} %ignored for now
\setlinkedinaccount{hier Account} %you can play with color of the template (red is also nice..)
\setgithubaccount{https://github.com/John-Dilla} %you can play with color of the template (red is also nice..)
...
I'm an undergraduate from Germany
}
%
%Education
\section{Education} 
